#ifndef __MEMORY_STREAM_LITTLE_H__
#define __MEMORY_STREAM_LITTLE_H__
...
public:
	...
	MemoryStreamLittle &operator<<(uint8_t value)
	{
		append<uint8_t>(value);
		return *this;
	}

	MemoryStreamLittle &operator<<(uint16_t value)
	{
		append<uint16_t>(value);
		return *this;
	}

	MemoryStreamLittle &operator<<(uint32_t value)
	{
		append<uint32_t>(value);
		return *this;
	}

	MemoryStreamLittle &operator<<(uint64_t value)
	{
		append<uint64_t>(value);
		return *this;
	}

	MemoryStreamLittle &operator<<(int8_t value)
	{
		append<int8_t>(value);
		return *this;
	}

	MemoryStreamLittle &operator<<(int16_t value)
	{
		append<int16_t>(value);
		return *this;
	}

	MemoryStreamLittle &operator<<(int32_t value)
	{
		append<int32_t>(value);
		return *this;
	}

	MemoryStreamLittle &operator<<(int64_t value)
	{
		append<int64_t>(value);
		return *this;
	}

	MemoryStreamLittle &operator<<(float value)
	{
		append<float>(value);
		return *this;
	}

	MemoryStreamLittle &operator<<(double value)
	{
		append<double>(value);
		return *this;
	}

	MemoryStreamLittle &operator<<(const char *str)
	{
	...
	MemoryStreamLittle &operator<<(bool value)
	{
		append<int8_t>(value);
		return *this;
	}
	...
	MemoryStreamLittle &operator>>(char *value)
	{
		while (length() > 0)
		{
			char c = read<char>();
	...
	void append(MemoryStreamLittle& stream)
	{
		wpos(stream.wpos());
		rpos(stream.rpos());
...
template<>
inline void MemoryStreamLittle::read_skip<char*>()
{
	uint8_t temp = 1;
	while (temp != 0)
		temp = read<uint8_t>();
...
template<>
inline void MemoryStreamLittle::read_skip<char const*>()
{
	read_skip<char*>();
}
...
#endif // __MEMORY_STREAM_LITTLE_H__